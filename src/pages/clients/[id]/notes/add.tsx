...
const AddNotePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/clients/${clientId}/notes`);
    } catch (error) {
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600 mb-4">
              The client you are trying to add a note to does not exist or has been deleted.
            </p>
            <Link
              href="/clients"
    ...
    <MainLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold">Add Note for {client.nom}</h1>
        </div>
